...
namespace SamllHax.MapleSyrup
{
    public class FpsCounter
    {
        ...
        public FpsCounter(IConfiguration configuration)
        {
        ...
        public void Report()
        {
            ...
            // TODO: Use ILogger instead of Console
            Console.WriteLine($"Measure time {timer.ToString("0.00")}s; fps: max:{max} avg:{average} min99:{min99} min:{min}; total: {times.Count}");
        }
